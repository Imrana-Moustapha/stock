...
void modifierProduitInteractif(GestionnaireStock& gestionnaire)
{
    ...
    while (continuer) {
        ...
        switch (choix) {
            ...
            case 3: produit->setPrixAchat(lireDouble("\t\tNouveau prix d'achat : ")); break;
            case 4: produit->setPrixVente(lireDouble("\t\tNouveau prix de vente : ")); break;
            case 5: produit->setSeuilAlerte(lireEntier("\t\tNouveau seuil d'alerte : ")); break;
            case 6:
                if (perissable != nullptr) {
